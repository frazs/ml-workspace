...
if ! hash qgis 2>/dev/null; then
    ...
    sudo -u jovyan echo "[Desktop Entry]
	Version=1.0
	Type=Application
	Name=QGIS Desktop
	Comment=
    ...
    chown jovyan:jovyan "/home/jovyan/Desktop/QGIS Desktop.desktop"
...
sudo -u jovyan conda clean -i

sudo -u jovyan conda install --override-channels -c conda-forge --yes \
      'fiona' \
      'gdal' \
      'geopandas' \
      'rasterio' \
...
sudo -u jovyan conda clean --all -f -y
